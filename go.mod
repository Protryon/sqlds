module github.com/Protryon/sqlds/v3
...
replace github.com/grafana/grafana-plugin-sdk-go => github.com/Protryon/grafana-plugin-sdk-go v0.0.0-20240111224603-fbabc533e901
